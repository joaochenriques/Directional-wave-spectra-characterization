...
The file 'Spectra_Condor.mat' was zipped and splitted in 28 files due to upload restrictions (filesizes < 25MB) of GitHub. Any questions should be addressed to the paper corresponding author. The code was developed by the first author of the paper during the WAVEBUOY project.
